      ...
      <div className="max-w-7xl ma-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:block">
          <div className="ml-4 flex items-center space-x-4">
            ...
            <a href="/services" className="text-white hover:bg-white hover:text-black rounded-lg p-2">
              Services
            </a>
        ...
        <div className='md-hidden flex items-center  '>
          <button className='inline-flex items-center justify-center p-2 rounded-lg 
          text-white md:text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white'
